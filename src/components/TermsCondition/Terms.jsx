...
const Terms = () => {
  return (
    <section className="font-sans font-serif font-mono">
      <div className="px-10 py-24 mb-20 text-left bg-gray-50 md:text-center">
      ...
      <div class="px-[6rem] pb-20 mx-auto prose">
        <h1 id="1legalnotices">1. Legal Notices</h1>
        ...
        <h1 id="2permittedandprohibiteduses">
        ...
        <h1 id="3usersubmissions">3 User Submissions</h1>
        ...
        <h1 id="4userdiscussionlistsandforums">
        ...
        <h1 id="5useofpersonallyidentifiableinformation">
        ...
        <h1 id="6indemnification">6. Indemnification</h1>
        ...
        <h1 id="7termination">7. Termination</h1>
        ...
        <h1 id="8warrantydisclaimer">8. WARRANTY DISCLAIMER</h1>
        ...
        <h1 id="10linkstoothermaterials">10. Links to Other Materials</h1>
        ...
        <h1 id="11notificationofpossiblecopyrightinfringement">
