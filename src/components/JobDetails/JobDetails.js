...
import JobData from '../JobList/JobData';
...
<>
                ...
                <div class="row gy-5 gx-4">
                    ...
                    <div class="col-lg-4">
                        <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                            ...
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Salary: {item.salary}</p>
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Location: {item.location}</p>
                            <p class="m-0"><i class="fa fa-angle-right text-primary me-2"></i>Dead Line: {item.deadline}</p>
                        </div>
                        <div class="bg-light rounded p-5 wow slideInUp" data-wow-delay="0.1s">
                            <h4 class="mb-4">Company Detail</h4>
                            <p class="m-0">Ipsum dolor ipsum accusam stet et et diam dolores, sed rebum sadipscing elitr vero dolores.
                             Lorem dolore elitr justo et no gubergren sadipscing, ipsum et takimata aliquyam et rebum est ipsum lorem diam.
                              Et lorem magna eirmod est et et sanctus et, kasd clita labore.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <h1 style={{textAlign: "center", justifyContent: "center", lineHeight: "50vh" }}>Apply for a Job First</h1>
)}
</>
